...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vtb_regfile___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
...
#ifdef VL_DEBUG
            Vtb_regfile___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
            VL_FATAL_MT("tb/tb_regfile.sv", 7, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        vlSelfRef.__VstlPhaseResult = Vtb_regfile___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD void Vtb_regfile___024root___eval_triggers_vec__stl(Vtb_regfile___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_regfile___024root___eval_triggers_vec__stl\n"); );
    Vtb_regfile__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool Vtb_regfile___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vtb_regfile___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_regfile___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vtb_regfile___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vtb_regfile___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_regfile___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD bool Vtb_regfile___024root___eval_phase__stl(Vtb_regfile___024root* vlSelf) {
    ...
    // Body
    Vtb_regfile___024root___eval_triggers_vec__stl(vlSelf);
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vtb_regfile___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
    }
#endif
    __VstlExecute = Vtb_regfile___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
...
VL_ATTR_COLD void Vtb_regfile___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    // Body
    if ((1U & (~ (IData)(Vtb_regfile___024root___trigger_anySet__act(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vtb_regfile___024root___ctor_var_reset(Vtb_regfile___024root* vlSelf) {
    ...
    vlSelf->tb_regfile__DOT__w_addr = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 1261886928293336980ull);
    vlSelf->tb_regfile__DOT__w_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10915254691915351953ull);
    vlSelf->tb_regfile__DOT__w_en = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13306170000850801312ull);
    vlSelf->tb_regfile__DOT__r_addr1 = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 10561290144428788727ull);
    vlSelf->tb_regfile__DOT__r_data1 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 11085948011306539541ull);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->tb_regfile__DOT__regfile__DOT__regs[__Vi0] = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16835868663623316242ull);
    }
    ...
    vlSelf->__Vtrigprevexpr___TOP__tb_regfile__DOT__clk__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
