...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { led_blink }]; #IO_L6N_T0_VREF_34 Sch=led[0]
...
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_o }]; #IO_L2P_T0_34 Sch=ck_mosi
